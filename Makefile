...
server:
	docker run --rm --volume `pwd`:/opt/calc --name apiserver --network apiserver --network-alias apiserver --env PYTHONPATH=/opt/calc --env FLASK_APP=app/api.py -p 5000:5000 -w /opt/calc calculator-app:latest flask run --host=0.0.0.0
